...
// I JUST CHANGED A CONSTRUCTOR BUT DIDN'T WANNA DO IT IN UR CODE IN CASE I MESSED UP SO THAT IS WHY THERE IS A NEW
public class FullTimeInfluencerNew extends User {
   ...
   public FullTimeInfluencerNew(String userName, String password, String userAt, int totalFollowers) {
      super(userName, password, userAt, totalFollowers);
      fullTimeInfluencer = true;

      this.accountsReached = 0;
      this.interactions = 0;
      this.gainedFollowers = 0;

   }

   protected FullTimeInfluencerNew(String userName, String password, String userAt, int totalFollowers,
                                   int pAccountsReached, int pInteractions, int pGainedFollowers) {
