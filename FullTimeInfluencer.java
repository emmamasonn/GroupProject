 ...
 * Sub FullTimeInfluencer Class.
 **/
public class FullTimeInfluencer extends UserInformation
{
   ...
   protected FullTimeInfluencer()
   {

   }//Default Constructor.

   protected FullTimeInfluencer(String pUser, String pRealName, int pTotalFollowers)
   {
      super(pUser, pRealName, pTotalFollowers);
      accountsReached = 0;
      interactions = 0;
      gainedFollowers = 0;
   }//Alternative Constructor.

   protected FullTimeInfluencer(String pUser, String pRealName, int pTotalFollowers, int pAccountsReached, int pInteractions, int pGainedFollowers)
   {
      super(pUser, pRealName, pTotalFollowers);
   ...
   {
      return (super.toString() + "\nThis week you have reached " + getAccountsReached() + " accounts.\nYou had " + getInteractions() + " interactions on your posts.\nLastly, you gained " + getGainedFollowers() + " new followers.");
